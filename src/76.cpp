...
public:
  string minWindow(string s, string t) {
    // Variable length sliding window style problem.
    // Invariant: A valid window within s has all characters (duplicates and uniques) of t.
    // Idea: Keep track of all the letters and their counts within t with a map.
    // Increase the window to the right until all letters are there, then move left pointer until invalid again.
    int left = 0;
